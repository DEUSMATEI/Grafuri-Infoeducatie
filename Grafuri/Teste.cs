...
namespace Grafuri
{
    public partial class Teste : Form
    {
        ...
        class graf 
        {
            ...
            public bool corectare_df(RichTextBox r, int nod_start)
            {
                try
                {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(gr.corectare_matad(richTextBox_matad)==true)
            {
        ...
        private void button_cerinta_urm_Click(object sender, EventArgs e)
        {
            ...
            if(gr.corectare_df(richTextBox_raspuns_df,nod_start )==true)
            {
